...
static const char *editorcmd[] = { "edit", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_Return, spawn,          {.v = termcmd } },
        { MODKEY|ShiftMask,             XK_e,      spawn,          {.v = killdwmcmd } },
        { 0,                            0x1008ff12, spawn,         {.v = volmutecmd } },
        { 0,                            0x1008ff13, spawn,         {.v = volupcmd } },
        { 0,                            0x1008ff11, spawn,         {.v = voldowncmd } },
        { 0,                            0x1008ff06, spawn,         {.v = brightnessdowncmd } },
        { 0,                            0x1008ff05, spawn,         {.v = brightnessupcmd } },
